...
# a10 = Animal.create :name => 'Pickles', :age => 7, :image => '/assets/sheepadoodle.jpeg.jpeg',:story => "Pickles is a sweet lady that is ready for a calm life of not having to worry about uncertainties.",
